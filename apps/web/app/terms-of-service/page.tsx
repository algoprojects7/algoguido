...
export const metadata: Metadata = {
  ...
  description:
    'Review the Terms of Service of Algoguido Technologies Private Limited. Outlining platform usage, legal jurisdiction (Guwahati), registration, payments, and billing policies.',
  alternates: {
    canonical: '/terms-of-service',
  },
  openGraph: {
    title: 'Terms of Service | Algoguido Technologies',
    description: 'Terms of Service and legal agreements of Algoguido Technologies Private Limited.',
    url: 'https://algoguido.com/terms-of-service',
    type: 'website',
    images: [
      {
        url: '/hero-image.png',
        width: 1200,
        height: 630,
        alt: 'Algoguido Technologies Terms of Service',
      },
    ],
  },
  twitter: {
...
const termsData = [
  ...
  },
  {
    ...
    paragraphs: [
      'Algoguido Technologies is an enterprise-grade AI-first technology company. We design, develop, deploy, and maintain custom software products, enterprise SaaS applications (such as LeadGrowAI, eduAI365, Nidaan Polyclinic, Apply4Jobs, and AI Workforce for Business), cloud infrastructures, and digital transformation architectures for government, corporate, and private enterprise clients.',
...
export default function TermsOfServicePage() {
  const jsonLd = {
    ...
    '@graph': [
      {
        '@type': 'WebPage',
        '@id': 'https://algoguido.com/terms-of-service/#webpage',
        'url': 'https://algoguido.com/terms-of-service',
        'name': 'Terms of Service | Algoguido Technologies',
        'description':
          'Review the Terms of Service of Algoguido Technologies Private Limited. Outlining platform usage, legal jurisdiction (Guwahati), registration, payments, and billing policies.',
        'publisher': {
      ...
      {
        '@type': 'BreadcrumbList',
        '@id': 'https://algoguido.com/terms-of-service/#breadcrumb',
        'itemListElement': [
          {
            '@type': 'ListItem',
            'position': 1,
          ...
          },
          {
            ...
            'item': 'https://algoguido.com/terms-of-service',
          },
        ],
      },
    ],
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-8">
              ...
              <div className="mt-6 p-5 rounded-2xl bg-gradient-to-br from-[#0052cc] to-blue-700 text-white">
                ...
                <a href="mailto:info@algoguido.com" className="inline-flex items-center gap-1.5 text-xs font-bold bg-white/15 hover:bg-white/25 text-white rounded-lg px-3 py-2 transition-all" aria-label="Email legal team">
          ...
          <article className="lg:col-span-3">
            ...
            <div className="mb-10 p-6 rounded-2xl bg-amber-50 border border-amber-200/70 flex gap-4">
              <div className="shrink-0 h-10 w-10 rounded-xl bg-amber-100 flex items-center justify-center" aria-hidden="true">
                <svg className="h-5 w-5 text-amber-650" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="space-y-12">
              {termsData.map((section, idx) => (
                <section key={section.id} id={section.id} className="scroll-mt-8">
                  ...
                  {idx < termsData.length - 1 && <div className="mt-10 border-t border-slate-100" aria-hidden="true" />}
                </section>
              ))}
            </div>
